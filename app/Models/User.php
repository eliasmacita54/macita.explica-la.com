...
static public function getParent()
{
    ...
    {
        {
            $return = self::select('users.*', 'class.name as class_name')
                            ...
                            if (!empty(Request::get('last_name'))) {
                              ...
                              if (!empty(Request::get('adminssion_number'))) {
                                $return = $return->where('users.adminssion_number', 'like', '%' .Request::get('adminssion_number'). '%');
                              }
    ...
    static public function getSeachStudent()
    {
...
return $return;
    ...
    static public function getTeacher()
    {
        ...
        if (!empty(Request::get('last_name'))) {
          ...
          if (!empty(Request::get('address'))) {
            $return = $return->where('class.address', 'like', '%' .Request::get('address'). '%');
          }

          if (!empty(Request::get('admission_date'))) {
            $return = $return->where('class.admission_date', 'like', '%' .Request::get('admission_date'). '%');
          }
