<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdownss" href="#">
...
<!-- Barra Lateral -->
<div class="sidebar">
    <!-- Painel do Usuário (opcional) -->
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="{{url('dist/img/user2-160x160.jpg')}}" class="img-circle elevation-2" alt="Imagem do Usuário">
      </div>
      <div class="info">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        <!-- Adicione ícones aos links usando a classe .nav-icon com font-awesome ou qualquer outra biblioteca de ícones -->
        ...
        <li class="nav-item @if(Request::segment(2) == 'class' || Request::segment(2) == 'subject' || Request::segment(2) == 'assign_subject' || Request::segment(2) == 'assign_class_teacher' || Request::segment(2) == 'class_timetable') menu-is-opening menu-open active @endif">
        ...
        <li class="nav-item @if(Request::segment(2) == 'examinations') menu-is-opening menu-open active @endif">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="{{url('admin/examinations/avaliation_schedule')}}" class="nav-link @if(Request::segment(3) == 'avaliation_schedule') active @endif">
                <i class="far fa-circle nav-icon"></i>
                <p>Horário das Avaliações</p>
              </a>
            </li>
            <li class="nav-item">
