          ...
          <div class="col-md-12">
                  <div class="card ">
                    <div class="card-header">
                        <h3 class="card-title">Seach Assign Subject </h3>
                    </div>
                    <form method="get" action="">
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group col-md-3">
                            <label >Date</label>
                            <input type="date" class="form-control" name="date" value=""  placeholder="Enter email">
                          </div>
                        <div class="form-group col-md-3">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Assign Subject Table</h3>
