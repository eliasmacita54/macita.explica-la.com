        ...
        <div class="row">
          ...
          <div class="card ">
                    <div class="card-header">
                        <h3 class="card-title">Seach Assign Class Teacher</h3>
                    </div>
                    <form method="get" action="">
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" name="subject_name" value="{{ Request::get('teacher_name')}}"   placeholder="Teacher Name">
                          </div>
                        <div class="form-group col-md-3">
                            <label >Date</label>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Assign Class Teacher Table</h3>
