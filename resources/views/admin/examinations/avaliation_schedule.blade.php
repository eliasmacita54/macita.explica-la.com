      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
                    ...
                    <form method="get" action="">
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <a href="{{ url('admin/examinations/avaliation_schedule') }}" class=" btn btn-success"  style="margin-top:30px;">reset</a>
                        </div>
                      </div>
                    </div>
                   </form>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Avaliation Schedule</h3>
